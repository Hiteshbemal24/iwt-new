...
// function sin() {
//     box = document.getElementById("box");
//     var result = Math.sin(parseFloat(box.innerText));
//     box.innerText = result.toPrecision(12);
// }

function sin() {
    var box = document.getElementById("box");
    var degreeValue = parseFloat(box.innerText);
    if (!isNaN(degreeValue)) {
        var radianValue = degreeValue * (Math.PI / 180);
        var result = Math.sin(radianValue);
        box.innerText = result.toFixed(6); 
    } else {
...
function cos() {
    box = document.getElementById("box");
    var result = Math.cos(parseFloat(box.innerText));
    box.innerText = result.toPrecision(12);
}

function tan() {
    box = document.getElementById("box");
    var result = Math.tan(parseFloat(box.innerText));
    box.innerText = result.toPrecision(12);
}

function log() {
    box = document.getElementById("box");
    var result = Math.log(parseFloat(box.innerText));
    box.innerText = result.toPrecision(12);
}

function exp() {
    box = document.getElementById("box");
    var result = Math.exp(parseFloat(box.innerText));
    box.innerText = result.toPrecision(12);
}
function pi() {
    box = document.getElementById("box");
    box.innerText = Math.PI.toPrecision(12);
}
